...
import ret_tim_func as ret
from raw_xml import rawdata
from mzml_xml import rawmzml
from read_datb_class import database
from lodes import lodes
from lodes1 import lodes1
from lodes2 import lodes2
import use_func as usf
import os
...
## input 
nglycan='Man6'
#fraw='./15cm_PGC/Blackbean_M7.raw'
#fraw='./15cm_PGC/Blackbean_M5_20210719175407.raw'
#fraw='./15cm_PGC/Blackbean_M6.raw'
#fraw='./WPbk_M5M10.raw'
fraw='./Blackbean_M7.raw'


#a=fraw.split('/')[2]
#fmzml='./'+a[:len(a)-3]+'mzML'
