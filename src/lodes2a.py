...
#                peaks_sel={'ms2a':ms2a}
                peaks_sel={'ms2a':ms2a,'ms2b':ms2b,'ms3_527':ms3_527,
                           'ms3_509':ms3_509,'ms4_365':ms4_365}
...
#                peaks_sel={'ms2a':ms2a}
                peaks_sel={'ms2a':ms2a,'ms2b':ms2b,'ms3_689':ms3_689,
                           'ms3_671':ms3_671,'ms4_365':ms4_365,'ms4_527':ms4_527}
...
#                peaks_sel={'ms2a':ms2a}
                peaks_sel={'ms2a':ms2a,'ms2b':ms2b,'ms3_851':ms3_851,
                           'ms3_833':ms3_833,'ms4_527':ms4_527}
            ...
            case "MAN6":
                ...
                peaks_sel={'ms2a':ms2a,'ms2b':ms2b,'ms2c':ms2c,'ms3_1013':ms3_1013,
                           'ms3_995':ms3_995,'ms4_527':ms4_527}
            ...
            case "MAN7":
                ...
                peaks_sel={'ms2a':ms2a,'ms2b':ms2b,'ms2c':ms2c,'ms3_1175':ms3_1175,
                           'ms3_1157':ms3_1157,'ms4_527':ms4_527}
...
#        mass_select,ms_level=self.mass_select()
    ...
    def ms_sim4(self,iso_list,in_spec,datab,score_calc):
        #initialize database,methods
        pref=self.database()
        met,peaks_sel=self.method()
        #print(len(in_spec))
        ...
        for i in range(len(in_spec)):
            ...
            if ml=='2':
                max2=ret.in_peaks4(a,b,peaks_sel.get('ms2a'))
                if score_calc==1:
                    scr1,tabl=usf.scr_1(mspect,spec_dat,max2)
                if score_calc==2:
                    scr1,tabl=usf.scr_2(mspect,spec_dat,max2)
                if score_calc==3:
                    scr1,tabl=usf.scr_3(mspect,spec_dat,max2)
                sc.append(['ms2_part1',scr1])
                ...
                try:
                    max2=ret.in_peaks4(a,b,peaks_sel.get('ms2c'))
                    if score_calc==1:
                        scr1,tabl=usf.scr_1(mspect,spec_dat,max2)
                    if score_calc==2:
                        scr1,tabl=usf.scr_2(mspect,spec_dat,max2)
